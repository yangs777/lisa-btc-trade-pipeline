"""Autogenerated smoke tests for src.data_processing.data_processing._io"""
import sys
...
class TestSrc_Data_Processing_Data_Processing__IoSmoke:
    """Smoke tests for src.data_processing.data_processing._io module."""

    def test_module_import(self):
        """Test that module can be imported."""
        try:
            import src.data_processing.data_processing._io
        except ImportError:
    ...
    def test_module_attributes(self):
        ...
        try:
            import src.data_processing.data_processing._io as mod

            # Check module has expected attributes
            assert hasattr(mod, "__name__")
            assert mod.__name__ == "src.data_processing.data_processing._io"
