"""Autogenerated smoke tests for src.feature_engineering.pattern.feature_engineering.pattern.psar"""
import pytest
...
class TestSrc_Feature_Engineering_Pattern_Feature_Engineering_Pattern_PsarSmoke:
    """Smoke tests for src.feature_engineering.pattern.feature_engineering.pattern.psar module."""
    ...
    def test_module_structure(self):
        ...
        try:
            ...
            if "." in "src.feature_engineering.pattern.feature_engineering.pattern.psar":
                parts = "src.feature_engineering.pattern.feature_engineering.pattern.psar".split(".")
                exec(f"from {'.'.join(parts[:-1])} import {parts[-1]}")
            else:
                __import__("src.feature_engineering.pattern.feature_engineering.pattern.psar")
