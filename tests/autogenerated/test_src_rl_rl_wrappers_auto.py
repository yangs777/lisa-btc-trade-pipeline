"""Autogenerated smoke tests for src.rl.rl.wrappers"""
...
class TestSrc_Rl_Rl_WrappersSmoke:
    """Smoke tests for src.rl.rl.wrappers module."""
    ...
    def test_module_structure(self):
        ...
        try:
            ...
            if "." in "src.rl.rl.wrappers":
                parts = "src.rl.rl.wrappers".split(".")
                exec(f"from {'.'.join(parts[:-1])} import {parts[-1]}")
            else:
                __import__("src.rl.rl.wrappers")
