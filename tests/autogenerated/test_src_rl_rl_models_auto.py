"""Autogenerated smoke tests for src.rl.rl.models"""
...
class TestSrc_Rl_Rl_ModelsSmoke:
    """Smoke tests for src.rl.rl.models module."""
    ...
    def test_module_structure(self):
        ...
        try:
            ...
            if "." in "src.rl.rl.models":
                parts = "src.rl.rl.models".split(".")
                exec(f"from {'.'.join(parts[:-1])} import {parts[-1]}")
            else:
                __import__("src.rl.rl.models")
