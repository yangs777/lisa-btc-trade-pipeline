"""Autogenerated smoke tests for src.rl.rl.environments"""
import pytest
...
class TestSrc_Rl_Rl_EnvironmentsSmoke:
    """Smoke tests for src.rl.rl.environments module."""
    ...
    def test_module_structure(self):
        ...
        try:
            ...
            if "." in "src.rl.rl.environments":
                parts = "src.rl.rl.environments".split(".")
                exec(f"from {'.'.join(parts[:-1])} import {parts[-1]}")
            else:
                __import__("src.rl.rl.environments")
