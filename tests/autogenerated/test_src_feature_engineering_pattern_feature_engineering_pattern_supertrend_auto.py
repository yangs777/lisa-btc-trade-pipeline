"""Autogenerated smoke tests for src.feature_engineering.pattern.feature_engineering.pattern.supertrend"""
import os
import sys
...
class TestSrc_Feature_Engineering_Pattern_Feature_Engineering_Pattern_SupertrendSmoke:
    """Smoke tests for src.feature_engineering.pattern.feature_engineering.pattern.supertrend module."""
    ...
    def test_module_structure(self):
        ...
        try:
            ...
            if "." in "src.feature_engineering.pattern.feature_engineering.pattern.supertrend":
                parts = "src.feature_engineering.pattern.feature_engineering.pattern.supertrend".split(".")
                exec(f"from {'.'.join(parts[:-1])} import {parts[-1]}")
            else:
                __import__("src.feature_engineering.pattern.feature_engineering.pattern.supertrend")
